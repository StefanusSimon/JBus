...
public class AccountController implements BasicGetController<Account> {
    ...
    @JsonAutowired(value = Account.class, filepath = "D:\\JBusAndroid Anus\\src\\main\\java\\com\\StefanusSimonJBusRS\\json\\account_db.json")
    public static JsonTable<Account> accountTable;

    static {
        try {
            accountTable = new JsonTable<>(Account.class, "D:\\JBusAndroid Anus\\src\\main\\java\\com\\StefanusSimonJBusRS\\json\\account_db.json");
        } catch (IOException e) {
